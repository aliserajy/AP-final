...
public class publicchatcontroller implements Initializable {
    ...
    public boolean createchannel(){
        ...
        if(Client.userOfProgram.getAbility(Client.userOfProgram)||Client.userOfProgram.isAdminOfServer()) {
    ...
    public void removeChanel(chanel ch){

        if(Client.userOfProgram.getAbility(Client.userOfProgram)||Client.userOfProgram.isAdminOfServer()){

            Iterator<chanel> it=serverlogincontroller.getServer().chanellist.iterator();
